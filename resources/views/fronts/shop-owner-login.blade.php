...
<div id="content" class="site-content" tabindex="-1">
    <div class="container">
        <nav class="woocommerce-breadcrumb" >
            ...
            <span class="delimiter"><i class="fa fa-angle-right"></i></span> Shop Owner
                            ...
                            <div class="customer-login-form">
                                ...
                                <div class="col2-set" id="customer_login">
                                    <div class="col-1">
                                        ...
                                        @endif
                                        <h2>Login</h2>
                                        <form action="{{url('owner/sign-in')}}" method="post" accept-charset="UTF-8" class="login">
                                            {{csrf_field()}}  
                                            ...
                                            <p class="lost_password"><a href="{{url('owner/account-recovery')}}">Forgot password?</a></p>
                                        </form>
                                    </div>
                                    <div class="col-2">
                                    @if(Session::has('sms'))
                                    ...
                                    @endif
                                        <h2>Register</h2>
                                        <form action="{{url('owner/sign-up')}}" accept-charset="UTF-8" method="post" class="register">
                                            {{csrf_field()}}    
