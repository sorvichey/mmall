...
<div id="content" class="site-content" tabindex="-1">
    <div class="container">
        <nav class="woocommerce-breadcrumb">
            <a href="{{url('/')}}">Home</a>
            <span class="delimiter"><i class="fa fa-angle-right"></i></span>Category
        </nav>
        <div id="primary" class="content-area">
            <main id="main" class="site-main">
                <header class="page-header">
                    <h1 class="page-title">Prodoct Category :</h1>
                </header>
                    <div class="shop-control-bar">
                        <ul class="shop-view-switcher nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" title="Grid View" href="#">
                                    <i class="fa fa-th"></i>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" title="List View" href="{{url('product/category/list-view/'.$cid)}}">
                                ...
                                <li class="product">
                                    <div class="product-outer">
                                        <div class="product-inner" style="height:335px;">
                                            <span class="loop-product-categories"><a href="{{url('product/category/'.$cid)}}" rel="tag">{{$b->category_name}}</a></span>
