...
<div id="content" class="site-content" tabindex="-1">
                <div class="container">
                    ...
                    <nav class="woocommerce-breadcrumb" ><a href="{{url('/')}}">Home</a><span class="delimiter"><i class="fa fa-angle-right"></i></span>Best Deal</nav>

                    <div id="primary" class="content-area">
                        <main id="main" class="site-main">
                            <header class="page-header">
                                <h1 class="page-title">Best Deal</h1>
                            </header>

                            <div class="shop-control-bar">
                                <ul class="shop-view-switcher nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" title="Grid View" href="#">
                                            <i class="fa fa-th"></i>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" title="List View" href="{{url('product/best-deal/list-view/')}}">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="grid" aria-expanded="true">
                                    ...
                                    <ul class="products columns-6">
                                        @foreach($best_deal_products as $b)
                                        <li class="product">
