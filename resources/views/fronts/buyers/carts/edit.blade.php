                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{url('/buyer/mycart/update')}}" method="post">
                                            ...
                                            <input type="hidden" name="cart_id" id="cart_id" value="{{ Crypt::encryptString($cart->id) }}">

                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="quantity">Quantity:</label>
                                                    <input type="number" min="1" value="{{$cart->pro_qty}}" class="form-control" id="quantity" placeholder="Enter Quantity" name="quantity" style="line-height:1.5em;">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <button type="button" class="btn btn-success" style="margin-left:15px !important;">Save Change</button>
                                        </form>
                                    </div> 
                                </div>
