                        ...
                        <div class="col-xs-12 col-lg-9">
                            <nav>
                                <ul id="menu-secondary-nav" class="secondary-nav">
                                    ...
                                    <li class="menu-item"><a href="{{url('product/best-deal')}}">Best Deal</a></li>
                                    <li class="menu-item"><a href="{{url('product/best-seller')}}">Best Seller</a></li>
                                    <li class="menu-item"><a href="{{url('product/new-arrival')}}">New Arrivals</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                        ...
                        <main id="main" class="site-main">
                            <div class="home-v1-slider" >
                            	...
                            	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                            		...
                            		<div class="item" style="background-image: url({{asset('uploads/slides/'.$s->photo)}});">
                            			<div class="container">
                            				<div class="row">
                            					<div class="col-md-offset-3 col-md-5">
                            						<div class="caption vertical-center text-left">
                            							...
                            							<div class="hero-2 fadeInDown-2">
                            								{{$s->short_description}} @if($s->discount!=null)<strong>{{$s->discount}}% Off</strong>@endif
                             							</div>
                                ...
                                <div class="tabs-block col-lg-12">
                                    <div class="products-carousel-tabs">
                                        <ul class="nav nav-inline">
                                            <li class="nav-item"><a class="nav-link active" data-toggle="tab">Best Deal</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab-products-1" role="tabpanel">
                                                <div class="woocommerce columns-4">
                                                    <ul class="products columns-6">
                                                        @foreach($best_deal_products as $best_deal)
                                                        <li class="product ">
                                                            <div class="product-outer">
                                                                <div class="product-inner" style="height: 335px;">
                                                                    <span class="loop-product-categories"><a href="{{url('product/category/'.$best_deal->category_id)}}" rel="tag">{{$best_deal->category_name}}</a></span>
                                                                        ...
                                                                        <div class="action-buttons">
                                                                            ...
                                                                            {{ csrf_field() }}
                                                                                @if(Session::has('buyer'))
                                                                                    ...
                                                                                    <input type="hidden" name="product_id" id="product_id" value="{{$best_deal->p_id}}">
                                                                                    <?php 
                                                                                        $wished = DB::table('wishes')
                                                                                            ->where('buyer_id', session('buyer')->id)
                                                                                            ->where('product_id', $best_deal->p_id)
                                                                                            ->count();
                                                                                    ?>
                                                                                @else 
                                                                                ...
                                                                                @if(Session::has('buyer'))
                                                                                    ...
                                                                                    @else
                                                                                    <a rel="nofollow" onclick="add_wish_list(this, event)"  class="add_to_wishlist" data-id="{{$best_deal->p_id}}" id="add_to_wishlist"> Wishlist</a>
                                                                                     @endif
                                                                                @endif
                            ...
                            <section class="section-product-cards-carousel animate-in-view fadeIn animated" data-animation="fadeIn">
                                ...
                                <header>
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item active"><a href=""><span class="nav-link">All Best Seller Category <i class="fa fa-arrow-right"></i></span></a></li>
                                    </ul>
                                </header>
                                    ...
                                    <div class="woocommerce columns-3 home-v1-product-cards-carousel product-cards-carousel owl-carousel">
                                        <ul class="products columns-3">
                                            @foreach($best_seller_products as $best_seller)
                                                ...
                                                <div class="product-outer" style="height: 243px;" >
                                                    <div class="media product-inner">
                                                        <a class="media-left" href="{{url('product/detail/'.$best_seller->p_id)}}">
                                                            <img class="media-object wp-post-image img-responsive" src="{{asset('uploads/products/featured_images/250/'.$best_seller->featured_image)}}" data-echo="{{asset('uploads/products/featured_images/250/'.$best_seller->featured_image)}}" alt="">
                                                        </a>
                                                        <div class="media-body">
                                                            <span class="loop-product-categories">
                                                                <a href="{{url('product/category/'.$best_seller->category_id)}}" rel="tag">{{$best_seller->category_name}}</a>
                                                            </span>

                                                            <a href="{{url('product/detail/'.$best_seller->p_id)}}">
                                                                <h3>{{$best_seller->name}}</h3>
                                                            </a>
                                                            <div class="price-add-to-cart">
                                                            <span class="price">
                                                                <span class="electro-price">
                                                                    <ins><span class="amount">US @if($best_seller->discount > 0)  {{$best_seller->price - ($best_seller->price / 100 * $best_seller->discount) }} @else {{$best_seller->price}}@endif</span></ins>
                                                                </span>
                                                                @if($best_seller->discount > 0) 
                                                                <div>
                                                                    <del>
                                                                        <span class="amount">US {{$best_seller->price}} </span>
                                                                    </del>
                                                                    <span style="font-size: 0.6em;"> | {{$best_seller->discount}} % off</span>
                                                                </div>
                                                                @endif
                                                            </span>
                                                            </div>
                                                            ...
                                                            <div class="hover-area">
                                                                ...
                                                                <form action="{{url('buyer/wish/save')}}" method="post">
                                                                    {{ csrf_field() }}
                                                                        @if(Session::has('buyer'))
                                                                            <input type="hidden" name="buyer_id" id="buyer_id" value="{{session('buyer')->id}}">
                                                                            <input type="hidden" name="product_id" id="product_id" value="{{$best_seller->p_id}}">
                                                                            <?php 
                                                                                $wished = DB::table('wishes')
                                                                                    ->where('buyer_id', session('buyer')->id)
                                                                                    ->where('product_id', $best_seller->p_id)
                                                                                    ->count();
                                                                            ?>
                                                                        @else 
                                                                        <a href="#" rel="nofollow"  class="add_to_wishlist"> Wishlist</a>
                                                                        ...
                                                                        @if(Session::has('buyer'))
                                                                            ...
                                                                            <span> <i class="fa fa-heart-o"></i> Added to</span> <a href="{{url('buyer/wishlist')}}" class="text-primary">wish list</a>
                                                                            @else
                                                                            <a rel="nofollow" onclick="add_wish_list(this, event)"  class="add_to_wishlist" data-id="{{$best_seller->p_id}}" id="add_to_wishlist"> Wishlist</a>
                                                                                @endif
                                                                        @endif
                            ...
                            <div class="home-v1-deals-and-tabs deals-and-tabs row animate-in-view fadeIn animated" data-animation="fadeIn">
                                <div class="tabs-block col-lg-12">
                                    <div class="products-carousel-tabs">
                                        <ul class="nav nav-inline">
                                            <li class="nav-item"><a class="nav-link active" data-toggle="tab">New Arrival</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab-products-1" role="tabpanel">
                                                <div class="woocommerce columns-4">
                                                    <ul class="products columns-6">
                                                        @foreach($product_new_arrivals as $best_deal)
                                                        <li class="product ">
                                                            <div class="product-outer">
                                                                <div class="product-inner" style="height: 335px;">
