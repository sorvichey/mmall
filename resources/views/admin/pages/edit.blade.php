...
<div class="row">
    <div class="col-sm-12">
        ...
        @endif
        <form action="{{url('admin/page/update')}}" enctype="multipart/form-data" class="form-horizontal" method="post">
            {{csrf_field()}}
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="title" value="{{$page->title}}" name="title" class="form-control" autofocus required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="file" name="photo" class="form-control" onchange="loadFile(event)">
                            <br>
                            <img src="{{asset('uploads/pages/'.$page->photo)}}" alt="" width="400" id="preview">
                        </div>
                    </div>
                </div>
                </div>
