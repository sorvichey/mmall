...
<div class="row">
<div class="col-sm-12">
    <h3 class="text-success">List Product Image</h3>
    <div>
        @if(Session::has('sms'))
    ...
    <div>
        ...
        @foreach($photos as $p)
            <tr>
                ...
                <td>
                    <a href="{{url('admin/product/photo/delete/'.$p->id . '?pid='.$p_id)}}" onclick="return confirm('You want to delete?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
        @endforeach
        </tbody>
