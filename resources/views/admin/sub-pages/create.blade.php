...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            @endif
            <form action="{{url('admin/sub-page/save')}}" enctype="multipart/form-data" class="form-horizontal" method="post">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="title" value="{{old('title')}}" name="title" class="form-control" placeholder="Sub-page name" autofocus required>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="description" id="description" rows="6" class="form-control ckeditor" required>
                                </textarea>
                            </div>
                        </div>    
                        <div class="form-group row">
