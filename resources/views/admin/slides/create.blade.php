                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" step="0.1" id="discount" name="discount" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="photo" class="control-label col-sm-3 lb">Photo <span class="text-danger">(1920x466)</span></label>
                            <div class="col-sm-9">
                                <input type="file" value="" required name="photo" id="photo" class="form-control" onchange="loadFile(event)">
                                <br>
                                <img src="{{asset('uploads/slides/default.jpg')}}" alt="" width="400" id="preview">
                            </div>
                        </div>
                        <div class="form-group row">
