...
<div class="row">
    <div class="col-lg-12">
        <strong>Create New Payment Type</strong>&nbsp;&nbsp;
        ...
        @endif
        <form action="{{url('/admin/payment-type/save')}}" enctype="multipart/form-data" method="post" id="frm" class="form-horizontal">
            {{csrf_field()}}
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <br>
                            <img src="{{asset('uploads/payment_types/default.png')}}" alt="" width="139" id="preview">
                        </div>
                    </div>
                    <div class="form-group row">
