...
<div class="row">
    <div class="col-lg-12">
        ...
        <a href="{{url('/admin/product/detail/'.$product->id)}}" class="text-success"><i class="fa fa-arrow-left"></i> Back</a>
        <hr>
        @if(Session::has('sms'))
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="discount" name="discount"  value="{{$product->discount}}" step="0.1"  min="0" value="0" required>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
