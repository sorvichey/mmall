...
<div class="row">
    <div class="col-lg-12">
        ...
        <a href="{{url('/admin/tracking-destination')}}" class="text-success"><i class="fa fa-arrow-left"></i> Back</a>
        <hr>
        @if(Session::has('sms'))
        ...
        @endif
        <form action="{{url('/admin/tracking-destination/update')}}" method="post" id="frm" class="form-horizontal">
            {{csrf_field()}}
