...
<head>
    ...
    <title>Product Management | M-Mall</title>
    <!-- Styles -->
    <!-- Bootstrap core CSS -->
...
<nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
    ...
    <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{url('/admin/product-management')}}"> <i class="fa fa-product-hunt"></i> Products  <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/product')}}" id="menu_product">Product</a>
                </li>
