...
<head>
    ...
    <title>Career Management | M-Mall</title>
    <!-- Styles -->
    <!-- Bootstrap core CSS -->
...
<nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
    ...
    <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item ">
                <a class="nav-link active" href="{{url('/admin/career-management')}}"><i class="fa fa-university"></i> Career</a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/career')}}" id="menu_career">Career</a>
                </li>
                <li class="nav-item"><strong><i class="fa fa-cogs"></i> Setting</strong></li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/career-category')}}" id="menu_career_category">Career Category</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/department-category')}}" id="menu_department_category">Department Category</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/career-location')}}" id="menu_career_location">Career Location</a>
                </li>
            </ul>
        </nav>
