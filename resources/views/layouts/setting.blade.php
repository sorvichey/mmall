...
<nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
    ...
    <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{url('/admin/customer-management')}}"> <i class="fa fa-users"></i> Customers </a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="{{url('/admin/career-management')}}"><i class="fa fa-university"></i> Career</a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="{{url('/admin/setting')}}"> <i class="fa fa-cogs"></i> Settings  <span class="sr-only">(current)</span></a>
            </li>
        </ul>
        <ul class="navbar-nav">
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                <li class="nav-item"><strong><i class="fa fa-cogs"></i> General Settings</strong></li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/sub-page')}}" id="menu_sub_page">Sub-Page</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/social')}}" id="menu_social">Social</a>
                </li>
                <li class="nav-item"><strong><i class="fa fa-cogs"></i> Footer Settings</strong></li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/payment-type')}}" id="menu_payment_type">Payment Type</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/phone-support')}}" id="menu_phone_support">Phone Support</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/contact-info')}}" id="menu_contact_info">Contact Info</a>
                </li>
                <li class="nav-item"><strong><i class="fa fa-cogs"></i> Security</strong></li>
                <li class="nav-item">
