                ...
                <div class="container">
                    ...
                    <nav>
                        <ul id="menu-top-bar-right" class="nav nav-inline pull-right animate-dropdown flip">
                            ...
                            <li class="menu-item animate-dropdown"><a title="Shop" href="shop.html"><i class="ec ec-shopping-bag"></i>{{trans("labels.shop")}}</a></li>
                ...
                <div class="container hidden-md-down">
                    <div class="row">
                        ...
                        <ul class="navbar-wishlist nav navbar-nav pull-right flip">
                        	<li class="nav-item">
                        		<a href="{{url('buyer/wishlist')}}" class="nav-link"><i class="ec ec-favorites"></i></a>
                        	</li>
                        </ul>
                        <ul class="navbar-mini-cart navbar-nav animate-dropdown nav pull-right flip">
                        	<li class="nav-item dropdown">
            	...
            	<div class="container">
            		...
            		<div class="collapse navbar-toggleable-xs" id="header-v3">
            			<ul class="nav navbar-nav">
                            <li class="menu-item"><a title="Gadgets" href="product-category.html">My Orders</a></li>
            				<li class="menu-item"><a title="Phones &amp; Tablets" href="{{url('buyer/wishlist')}}">Wish List</a></li>
                            <li class="menu-item"><a title="Games &amp; Consoles" href="product-category.html">Message Center</a></li>
                            <li class="menu-item"><a title="Accessories" href="product-category.html">My Favorite Stores</a></li>
                            <li class="menu-item"><a title="TV &amp; Audio" href="product-category.html">Account Settings</a></li>
            			</ul>
            		</div><!-- /.collpase -->
            	</div><!-- /.-container -->
            </nav><!-- /.navbar -->
