...
class SecurityController extends Controller
{
    ...
    public function buyer_account_recovery() {
        return view("fronts.buyers.buyer-account-recovery");
    }
    ...
    {
        $data['id'] = $id;
        return view("fronts.buyers.buyer-new-password", $data);
    }
    ...
    public function buyer_activated_account() {
        ...
        return view("fronts.buyers.buyer-activated-account");
    }
    ...
    public function buyer_account_setting($id){
        ...
        return view("fronts.buyers.buyer-account-setting",$data);
    }
