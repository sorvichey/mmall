...
class OwnerProductColorController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('fronts.shops.products.color', $data);
    }
    public function delete($id)
    {
        ...
        DB::table("product_colors")->where('id', $decrypted_id)->where('product_id', $decrypted_pid)->delete();
        return redirect('/owner/product/detail/'.$encrypted_pid.'/color');
    }
    public function save(Request $r)
    {
        ...
        if($i)
        {
            ...
            return redirect('/owner/product/detail/'.$encrypted_id.'/color');
        }
        else{
